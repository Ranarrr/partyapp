...
public class ChauffeurAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(chauffeur.getM_fornavn().equals("£££") && chauffeur.getM_fornavn().equals("£££") && chauffeur.getM_rating() == 0.0 && chauffeur.getM_age() == 0 && chauffeur.getM_capacity() == 0) {
            convertView = thisActivity.getLayoutInflater().inflate(R.layout.chatmessage_footer, parent, false);
            ((TextView) convertView.findViewById(R.id.text_footer)).setText("Finner ingen sjåfører.");
            return convertView;
        }
        ...
        if(convertView != null) {
                ...
                public void onClick(View v) {
                    ...
                    send.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            list.add(new Chatter(chauffeur.getM_brukernavn(), chauffeur.getM_fornavn(), chauffeur.getM_etternavn()));
            ...
            navn.setText(String.format(Locale.ENGLISH, "%s %s (%d)", chauffeur.getM_fornavn(), chauffeur.getM_etternavn(), chauffeur.getM_age()));
